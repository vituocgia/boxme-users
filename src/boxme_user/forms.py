...
class BoxmeUserCreationForm(forms.ModelForm):
    ...
    def clean_email(self):
        ...
        """
        # Since BoxmeUser.email is unique, this check is redundant,
    ...
    def save(self, commit=True):
        ...
        :return boxme_user.models.BoxmeUser: user

        """
        user = super(BoxmeUserCreationForm, self).save(commit=False)
